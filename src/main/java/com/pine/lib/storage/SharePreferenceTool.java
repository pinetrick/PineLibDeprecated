...
public class SharePreferenceTool {
	private static SharePreferenceTool sharePreferenceTool;
	private Context context;
	private SharedPreferences sp = null;
	private Editor edit = null;

	/**
	 * Create DefaultSharedPreferences 设置属性或者读取属性
	 * 
	 * @param context
	 */
	public SharePreferenceTool(Context context) {
		this(context, PreferenceManager.getDefaultSharedPreferences(context));
	}

	/**
	 * Create SharedPreferences by filename 设置普通属性
	 * 
	 * @param context
	 * @param filename
	 * 
	 */
	public SharePreferenceTool(Context context, String filename) {
	 ...
	 * @param sp
	 */
	public SharePreferenceTool(Context context, SharedPreferences sp) {
		M.i().addClass(this);
	...
	public static SharePreferenceTool i() {
		if (sharePreferenceTool == null) {
			sharePreferenceTool = new SharePreferenceTool(A.c());
		}
		return sharePreferenceTool;
	}
