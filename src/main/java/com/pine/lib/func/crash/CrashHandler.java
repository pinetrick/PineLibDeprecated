...
{
	private static G g = new G(CrashHandler.class);
	/** Debug Log Tag */
	...
	public static CrashHandler i(Context ctx)
	{
		if (INSTANCE == null)
		{
	...
	private boolean handleException(Throwable ex)
	{
		...
		final CrashBean bean = new CrashBean();
		...
		new Thread() {
			...
			public void run()
			{
				...
				Looper.prepare();
				Toast.makeText(mContext, "闪退:" + bean.getType(), Toast.LENGTH_LONG)
						.show();
				Looper.loop();
			}
		}.start();
