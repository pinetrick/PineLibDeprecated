 ...
 */
public class ReleaseCrashHandler implements UncaughtExceptionHandler
{
	private static G g = new G(ReleaseCrashHandler.class);
	/** Debug Log Tag */
	public static final String TAG = "CrashHandler";
	/** 是否开启日志输出, 在Debug状态下开启, 在Release状态下关闭以提升程序性能 */
	public static final boolean DEBUG = G.getEnableGlobalDebug();
	/** CrashHandler实例 */
	private static ReleaseCrashHandler INSTANCE;
	/** 程序的Context对象 */
	...
	public static ReleaseCrashHandler i(Context ctx)
	{
		if (INSTANCE == null)
		{
			INSTANCE = new ReleaseCrashHandler();
			INSTANCE.init(ctx);
		}
		return INSTANCE;
	}
	...
	public void uncaughtException(Thread thread, Throwable ex)
	{
		...
		else
		{
			...
			System.exit(10);
			// final Intent intent = A.c().getPackageManager()
			// .getLaunchIntentForPackage(A.c().getPackageName());
	...
	private boolean handleException(Throwable ex)
	{
		...
		new Thread() {
			...
			public void run()
			{
				...
				Looper.prepare();
//				MessageBox.i(A.a()).setListener(new OnMessageClickListener() {
//
//					@Override
...
//				}).show("很抱歉,程序出现异常,即将退出.");
	...
	public String getInfo(Throwable ex)
	{
