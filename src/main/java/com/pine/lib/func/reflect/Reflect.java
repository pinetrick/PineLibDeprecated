package com.pine.lib.func.reflect;
...
import afinal.annotation.sqlite.ManyToOne;
import afinal.annotation.sqlite.OneToMany;
import afinal.annotation.sqlite.Property;
import afinal.annotation.sqlite.Transient;
import afinal.reflect.ClassUtils;
...
public class Reflect
{
	...
	public static Field getFieldByColumnName(Class<?> clazz, String columnName)
	{
		...
		if (columnName != null)
		{
			...
			{
				if (columnName.equals(ClassUtils.getPrimaryKeyColumn(clazz))) field = ClassUtils
						.getPrimaryKeyField(clazz);
